...
평년일경우 2월달의 마지막일은 28
출력: xxxx년 x월 마지막일은 xx일 입니다.
'''
#year = int(input("연도를 입력하세요: "))
#month = int(input("월을 입력하세요: "))
# if (month == 1) or (month == 3) or (month == 5) or (month == 7) or (month == 8) or (month == 10) or (month == 12):
#     print("{}년 {}월 마지막 일은 31일 입니다.".format(year,month))
# elif (month == 4) or (month == 6) or (month == 9) or (month == 11):
#     print("{}년 {}월 마지막 일은 30일 입니다.".format(year, month))
# else:
#     if ((year % 4 == 0 and year % 100 != 0) or (year% 400 == 0)) and (month == 2):
#         print("{}년 2월 마지막 일은 29일 입니다.".format(year))
#     else:
#         print("{}년 2월 마지막 일은 28일 입니다.".format(year))
# 중첩구문
...
print('operator priority - ', 5 + 10 > 3 and 7 + 3 == 10)
...
# 주민번호 >> 성별 >> xxxxxx - 1xxxxx
# 지역코드 00~08 : 서울지역
ssn = 'xxxxxx-107xxxx'
gender = ssn.split('-')[1]
print('type - ', type(gender),gender)
result = '남자' if gender[0] == '1' or gender[0] == 3 else '여자'
location = '서울' if int(gender[1:3]) in range(0,9) else '서울이 아님'
...
print('type - ',type(score),len(scores))
print('data - ',scores)
