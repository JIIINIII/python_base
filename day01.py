...
추후에 진행할 데이터 사이언스 및 인공지능을 위한 과정이고
전, 파이썬을 사랑합니다.....''')
print()
print("Seop's Python~~~")
...
print('010','8866','5157',sep='-')
print('eldoljini','naver.com',sep='@')
...
print('섭섭해님의 나이는 : %d 이고 성별 : %s 입니다.'.format(50,'남자'))
...
import keyword
kw = keyword.kwlist
print('type - ',type(kw))  # 변수 type 확인하는 습관 중요!!
print('data - ',kw)
